...
<style>
  ...
  .sub{color:#6b7280;font-size:13px;margin:0 0 22px;font-family:Inter,-apple-system,'Segoe UI',Arial,sans-serif}
  ...
  .ok{color:#0f7a58}
  .chip{display:inline-block;border-radius:0;padding:3px 12px;font-size:14px;font-weight:700;
    font-family:Inter,-apple-system,'Segoe UI',Arial,sans-serif}
  ...
  table{border-collapse:collapse;width:100%;margin:8px 0 14px;font-size:13px;
    font-family:Inter,-apple-system,'Segoe UI',Arial,sans-serif}
  th{font-size:11px;text-transform:uppercase;letter-spacing:.06em;color:#6b7280;text-align:left;
  ...
  li{margin:3px 0}
  .foot{margin-top:34px;padding-top:12px;border-top:1px solid #e5e7eb;color:#6b7280;font-size:12px;
    font-family:Inter,-apple-system,'Segoe UI',Arial,sans-serif}
  @media print{ .toolbar{display:none} .page{padding:0} body{font-size:13px} }
</style>
</head>
<body>
<div class="page">
...
function openHealthReport(){
  ...
  try{
    w.document.write(`<!doctype html><html><head><meta charset="utf-8"><title>${_hrEsc(i18t('hr_title'))}</title></head><body style="font-family:Inter,-apple-system,'Segoe UI',Arial,sans-serif;padding:40px;color:#374151">${_hrEsc(i18t('hr_building'))}</body></html>`);
  }catch(_){}
  (async()=>{
    let imgs={};
    ...
    try{ html=buildHealthReportHtml(healthReportData(), imgs); }
      ...
      html=`<!doctype html><body style="font-family:Inter,-apple-system,'Segoe UI',Arial,sans-serif;padding:40px;color:#374151">${_hrEsc(i18t('hr_failed'))}</body>`;
    }
