...
# THE DAY-BY-DAY REPORTS, MOVED HERE 27 Aug 2026

Ten entries in CLAUDE.md were a diary of one day's batch of unrelated fixes
rather than a rule for future work — titled by the count of that day's fixes
("Six off five screenshots") rather than by a subject. They are reproduced below
WORD FOR WORD. What each one still RULES stayed behind in CLAUDE.md under the
same heading, so every cross-reference still resolves and the pointer says the
story is here.

Nothing was deleted and nothing was rewritten. If a rule looks thin in the
rulebook, its full reasoning is in this part, under the same subject.
...
## THE CONTRACT SCALES TO FILL ITS COLUMN (owner-asked 13 Aug 2026)
...
## "N NOT SENT" ON THE CHANGE COLUMN — the band, retired 26 Aug 2026
...
## THE REDLINE CO-PILOT (W3-1) — the full record, retired 24 Aug 2026
...
## THE TRACKED-CHANGES HEAD — RENDER B, the arrangement B1 replaced
