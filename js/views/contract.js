...
function uploadConfirmHtml(ext, meta){
  ...
  return `
      ...
      ${ext&&isOcrText(ext.textSource)?`<div style="display:flex;align-items:flex-start;gap:var(--s-2);border:1px solid var(--st-amber-line);background:var(--st-amber-bg);color:var(--st-amber-fg);border-radius:0;padding:var(--s-2) 11px;font-size:var(--t-meta);line-height:1.55;margin:0 0 var(--s-3)">
      ...
      ${extras.length?`<details style="margin:0 0 var(--s-3);border:1px solid var(--color-divider);border-radius:0;padding:var(--s-2) var(--s-3)">
...
function renderUploadSteps(active, note){
  ...
  host.innerHTML=`<div style="padding:10px var(--s-3);border:1px solid var(--color-divider);background:var(--color-bg);border-radius:0">
...
async function runUploadPipeline(file){
  ...
  const refuse=(msg)=>{
    ...
    if(steps){ steps.classList.remove('hidden');
      steps.innerHTML=`<div style="border:1px solid var(--st-ruby-line);background:var(--st-ruby-bg);color:var(--st-ruby-fg);border-radius:0;padding:10px var(--s-3);font-size:var(--t-meta);line-height:1.55">${msg}</div>`; }
    revive();
  };
  ...
  openModal(`
    <div style="padding:var(--s-6) 26px 20px;height:100%;display:flex;flex-direction:column;min-height:0">
      <div style="${COL};padding:0 26px">
        ...
        ${wasRich?`<div style="display:flex;gap:7px;align-items:flex-start;border:1px solid var(--st-steel-line);background:var(--st-steel-bg);border-radius:0;padding:var(--s-2) 11px;margin:0 0 10px;font-size:var(--t-meta);line-height:1.5;color:var(--st-steel-fg)">
      ...
      <textarea id="ed-text" class="scroll-thin" spellcheck="false" style="${COL};flex:1 1 auto;min-height:0;border:1px solid var(--color-divider);background:var(--color-surface);border-radius:0;padding:22px 26px;font:inherit;font-size:var(--t-card);line-height:1.95;resize:none;outline:none">${esc(cur)}</textarea>
      <div style="${COL};padding:0 26px;margin-top:var(--s-3)">
        <label style="display:flex;align-items:flex-start;gap:var(--s-2);border:1px solid var(--color-divider);background:var(--color-bg);border-radius:0;padding:9px 11px;font-size:var(--t-meta);cursor:pointer">
  ...
  return `
    <div id="ws-openpoints" style="border:1px solid var(--st-amber-line);background:var(--st-amber-bg);border-radius:0;padding:14px 18px;margin:0 0 14px;box-shadow:var(--shadow-sm)">
      ...
      <div style="display:flex;flex-direction:column;gap:var(--s-2)">
        ${pts.map((pt,i)=>`
          <div style="border:1px solid #e8d5ad;background:var(--color-surface);border-radius:0;padding:9px var(--s-3);font-size:var(--t-meta);line-height:1.6">
...
function docBody(c){
  ...
  const clause=(n,title,body)=>{
    ...
    const tag=p?`<span style="font-size:var(--t-figure);font-weight:var(--w-title);letter-spacing:.06em;text-transform:uppercase;background:${p.bg};color:${p.fg};padding:1px 6px;border-radius:0;flex:none">${p.tag}</span>`:'';
...
function templateProvenanceHtml(c){
  ...
  return `<div style="display:flex;align-items:flex-start;gap:7px;font-size:var(--t-label);line-height:1.5;color:var(--color-neutral-700);border:1px solid var(--color-divider);background:var(--color-surface);box-shadow:0 1px 2px rgba(15,23,42,.05);border-radius:0;padding:10px 13px">
...
function ktStreamRowHtml(c){
  ...
  const SEL='min-width:0;width:100%;border:1px solid var(--color-accent);background:var(--color-bg);border-radius:0;padding:var(--s-1) var(--s-2);font:inherit;font-size:var(--t-meta);text-align:right;outline:none';
...
function ktTermsRowsHtml(c,opts={}){
  ...
  const KIN='min-width:0;width:100%;border:1px solid var(--color-accent);background:var(--color-bg);border-radius:0;padding:var(--s-1) var(--s-2);font:inherit;font-size:var(--t-meta);text-align:right;outline:none';
  const dash=`<span class="kt-none" data-kt-none="1">${i18t('ct_not_set')}</span>`;
  ...
  openModal(`
    <div style="height:100%;display:flex;flex-direction:column;min-height:0">
      ...
      <div class="scroll-thin" style="flex:1;min-height:0;overflow-y:auto;padding:20px 26px;background:var(--color-bg)">
        <div style="${COL}">
          <textarea id="nego-prop-text" spellcheck="false" style="width:100%;min-height:52vh;border:1px solid var(--color-divider);background:var(--color-surface);border-radius:0;padding:14px var(--s-4);font:inherit;font-family:var(--font-mono);font-size:var(--t-body);line-height:1.8;outline:none;resize:vertical">${esc(base)}</textarea>
          <label style="display:block;margin-top:var(--s-3)">
            ...
            <input id="nego-prop-why" type="text" placeholder="${esc(i18t('ct_ph_reason'))}" style="width:100%;border:1px solid var(--color-divider);background:var(--color-surface);border-radius:0;padding:9px 11px;font:inherit;font-size:var(--t-body);outline:none"/>
          </label>
        </div>
      </div>
...
function renderWorkspace(){
  ...
  const KIN='min-width:0;max-width:62%;border:1px solid var(--color-divider);background:var(--color-bg);border-radius:0;padding:3px 7px;font:inherit;font-size:var(--t-meta);text-align:right;outline:none';
        ...
        <div style="display:flex;flex-direction:column;gap:var(--s-3)">
          ...
          <section style="${CARD};padding:var(--s-3) 14px">
            <div style="display:flex;align-items:center;gap:var(--s-2);margin-bottom:10px">
              ...
              <span style="display:inline-flex;align-items:center;gap:5px;font-size:var(--t-label);color:var(--st-green-fg);font-weight:var(--w-strong)"><span class="live-dot" style="height:6px;width:6px;border-radius:0;background:var(--st-green-dot);display:inline-block"></span>${i18t('ct_live')}</span>
            </div>
            ...
            <div style="margin-top:var(--s-3);padding-top:11px;border-top:1px solid var(--color-divider)">
              ...
              <div style="display:flex;gap:7px">
                <textarea id="comment-input" class="chat-field" rows="1" placeholder="${i18t('ct_add_comment')}" title="${i18t('ct_internal_to_team')}" style="flex:1;min-width:0;border:1px solid var(--color-divider);background:var(--color-bg);border-radius:0;padding:var(--s-2) 11px;font-size:var(--t-meta);outline:none"></textarea>
  ...
  openModal(`
    <div style="padding:22px var(--s-6)">
      ...
      <label style="display:block;margin-bottom:10px"><span style="display:block;font-size:var(--t-label);font-weight:var(--w-strong);color:var(--color-neutral-700);margin-bottom:var(--s-1);font-family:var(--font-mono)">${i18t('ct_date_signed')}</span>
        <input id="ps-date" type="date" style="width:100%;border:1px solid var(--color-divider);background:var(--color-surface);border-radius:0;padding:7px 10px;font:inherit;font-size:var(--t-body);outline:none"/></label>
      <label style="display:block;margin-bottom:10px"><span style="display:block;font-size:var(--t-label);font-weight:var(--w-strong);color:var(--color-neutral-700);margin-bottom:var(--s-1);font-family:var(--font-mono)">${i18t('ct_note_optional')}</span>
        <input id="ps-note" type="text" placeholder="${esc(i18t('ct_ph_signed_note'))}" style="width:100%;border:1px solid var(--color-divider);background:var(--color-surface);border-radius:0;padding:7px 10px;font:inherit;font-size:var(--t-body);outline:none"/></label>
