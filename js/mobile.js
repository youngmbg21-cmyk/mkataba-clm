...
@media (max-width:767px){
  ...
  .m-chip{
    ...
    border-radius:var(--radius); cursor:pointer; font:inherit; font-size:15px; font-weight:600;
  ...
  .m-sheet{
    ...
    border-radius:var(--radius); padding:10px 16px calc(env(safe-area-inset-bottom,0px) + 26px);
  ...
  .m-input, .m-area{
    ...
    border-radius:var(--radius); padding:12px; font:inherit; font-size:16px; line-height:1.5;
  ...
  .m-pill{
    flex:none; font-size:15px; font-weight:600; padding:3px 10px; border-radius:var(--radius);
    white-space:nowrap;
  }
  ...
  .m-kpi{
    ...
    border-radius:var(--radius); padding:12px 14px; cursor:pointer; font:inherit; color:inherit;
  ...
  .m-ngband-n{ font-family:var(--font-mono); font-size:13px; font-weight:700;
    ...
    border:1px solid var(--color-divider); border-radius:var(--radius); padding:0 8px; }
  ...
  .m-notices-min{
    pointer-events:auto; min-height:44px; border:1px solid var(--color-accent-300); border-radius:var(--radius);
  ...
  return `
    ...
    <div class="m-card" style="padding:12px">
      <input id="m-acct-title" type="text" value="${mEsc((u&&u.title)||'')}"
        ...
        style="width:100%;border:1px solid var(--color-divider);background:var(--color-surface);border-radius:var(--radius);padding:10px 12px;font:inherit;font-size:15px;color:inherit;outline:none"/>
