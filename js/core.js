...
function startApp(){
  ...
  setView(['dashboard','register','pipeline','advice','intake','obligations','folder','intel','calendar','reports','templates','playbook','workspace','team','directory','migration','redline'].includes(state.view)?state.view:'dashboard');
