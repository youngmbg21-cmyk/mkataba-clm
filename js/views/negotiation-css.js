...
<style id="nego-style">
  ...
  .nego-room, #nego-root, .nego-selmenu, .nego-aipop{
    ...
    /* ---- THE CARDS ARE SQUARE ----
       ...
       left alone. */
    ${''/* AND SINCE 26 Aug 2026 --n-r-* IS THE PAPER'S OWN AND STAYS ZERO.
           It had four readers and they were two different things: .nego-doc
           and .nego-clause are the two-pane view's PAPER, and .nego-card and
           .nego-work are furniture. When the platform took a 2px radius the
           furniture was pointed at --radius directly and this token kept the
           paper, which is what its name means here now — a document on screen
           reads as a document, not as a card. Do not point it at --radius. */}
  ...
  .nego-exit{display:inline-flex;align-items:center;gap:6px;flex:none;
    ...
    border-radius:var(--radius);padding:4px 11px;font:inherit;font-size:13px;font-weight:600;cursor:pointer;
  ...
  .nego-tbtn{border-radius:var(--radius);padding:6px 13px;font:inherit;font-size:14px;font-weight:600;
  ...
  .nego-gaps .renum{display:inline-block;margin-top:7px;font:inherit;font-size:12px;font-weight:700;
    color:var(--st-amber-fg);background:var(--n-paper);border:1px solid var(--st-amber-dot);border-radius:var(--radius);padding:4px 10px;cursor:pointer}
  ...
  .nego-who{display:inline-flex;align-items:center;gap:7px;border:1px solid rgba(255,255,255,.28);
    border-radius:var(--radius);padding:2px 4px 2px 9px;background:rgba(255,255,255,.06)}
  ...
  .nego-rz::before{content:"";width:2px;height:60px;border-radius:var(--radius);background:#c4cfdb;transition:background .15s ease}
  ...
  .nego-fold{margin-left:auto;flex:none;border:1px solid #d6e0ea;background:var(--n-badge-bg);
    color:var(--n-slate-soft);border-radius:var(--radius);padding:2px 8px;font:inherit;font-size:12px;
  ...
  ${''/* THE MARKS ARE DRAWN ON THE PAPER, SO THEY STAY SQUARE (26 Aug 2026,
         with the platform's 2px radius). A tracked change in Word is a plain
         highlight; a rounded one reads as a chip laid over the wording rather
         than as the wording itself. Same rule as the sheet they sit on. */}
  ...
  .nego-filterbar{display:flex;align-items:center;gap:9px;flex-wrap:wrap;
    font-family:var(--n-font-ui);font-size:13px;padding:7px 11px;border-radius:var(--radius);
  ...
  .nego-vis{display:inline-flex;align-items:center;gap:4px;font-family:var(--n-font-ui);
    font-size:12px;font-weight:700;letter-spacing:.04em;border-radius:var(--radius);padding:2px 8px;white-space:nowrap}
  ...
  .nego-mode{display:flex;align-items:center;gap:10px;flex-wrap:wrap;flex:none;
    font-family:var(--n-font-ui);font-size:13px;padding:8px 13px;border-radius:var(--radius);
  ...
  .nego-count{font-family:var(--n-font-mono);font-size:12px;font-weight:700;
    background:var(--n-slate);color:#fff;border-radius:var(--radius);padding:1px 8px}
  ...
  .nego-edit-bar button{font-size:calc(11px * var(--doc-scale,1));font-weight:700;border-radius:var(--radius);
  ...
  .nego-vsel{font:inherit;font-size:13px;font-weight:700;color:var(--n-ink);background:var(--n-paper);
    border:1px solid var(--n-line);border-radius:var(--radius);padding:4px 8px;max-width:min(60%,320px);cursor:pointer}
  ...
  .nego-clean-btn{margin-left:auto;flex:none;border:1px solid var(--n-slate);background:var(--n-paper);
    color:var(--n-slate);border-radius:var(--radius);padding:3px 10px;font:inherit;font-size:12px;font-weight:700;
  ...
  .nego-whose{margin-left:0;font-size:12px;font-weight:700;letter-spacing:.04em;
    border-radius:var(--radius);padding:2px 8px;white-space:nowrap;max-width:170px;
  ...
  .nego-round{margin-bottom:8px;border:1px solid var(--n-line);border-radius:var(--radius);
  ...
  .nego-hash{font-family:var(--n-font-mono);font-size:12px;color:var(--n-slate-soft);
    background:var(--n-badge-bg);border:1px solid #dde5ee;border-radius:var(--radius);padding:4px 7px;
  ...
  .nego-acts button{flex:1;border-radius:var(--radius);padding:6px 0;font:inherit;font-size:13px;font-weight:700;
  ...
  .nego-index-send button{width:100%;border:0;border-radius:var(--radius);padding:8px 0;font:inherit;font-size:13px;
  ...
  .nego-bulk button{flex:1;border:0;border-radius:var(--radius);padding:7px 0;font:inherit;font-size:13px;
  ...
  .nego-tmin{flex:none;border:1px solid var(--n-line);background:var(--n-paper);
    color:var(--n-ink-soft);border-radius:var(--radius);padding:2px 9px;font:inherit;font-size:12px;
  ...
  .nego-compose button{background:var(--n-slate);color:#fff;border:0;border-radius:var(--radius);padding:0 12px;
...
function redlineLayoutCss(){
  ...
  .redline-page .rl-round{flex:none;font-size:12px;font-weight:700;padding:2px 8px;border-radius:var(--radius);
  ...
  .rl-type-step{display:flex;align-items:center;gap:4px;flex:none;
    background:var(--color-neutral-100);border:1px solid var(--color-divider);padding:4px;border-radius:var(--radius)}
  ...
  .redline-page .rl-needs{display:flex;align-items:center;gap:8px;height:auto;flex:none;border:0;
    background:none;border-radius:var(--radius);padding:0;font:inherit;font-size:13px;font-weight:400;
  ...
  .rl-note-card{pointer-events:auto;border:1px solid var(--color-divider);
    background:var(--color-surface);border-radius:var(--radius);padding:12px 14px;
  ...
  .rl-note-btn{margin-top:10px;height:29px;border:1px solid var(--color-divider);
    border-radius:var(--radius);background:var(--color-surface);padding:0 12px;font:inherit;font-size:13px;
  ...
  .rl-notices-min{pointer-events:auto;align-self:flex-end;border:1px solid var(--color-accent-300);
    background:var(--color-accent-100);border-radius:var(--radius);padding:5px 11px;font:inherit;font-size:12px;
  ...
  .redline-page select.rl-jump{flex:0 1 auto;min-width:96px;max-width:calc(220px + 9ch);overflow:hidden;
    ...
    background:var(--color-surface);border-radius:var(--radius);padding:6px 8px;font:inherit;font-family:var(--font-mono);
  ...
  .redline-page .rl-livelist{flex:none;align-self:center;display:inline-flex;align-items:center;
    gap:7px;border:0;background:none;color:var(--color-accent-800);border-radius:var(--radius);padding:0;
  ...
  .redline-page .rl-pb-btn{flex:none;border:1px solid var(--color-divider);background:var(--color-surface);
    ...
    border-radius:var(--radius);padding:6px 11px;font:inherit;font-size:13px;font-weight:700;cursor:pointer;
    transition:background .12s,border-color .12s,color .12s}
  ...
  .redline-page .rl-unsent{display:flex;flex-basis:100%;align-items:center;gap:9px;
    margin:0 0 12px;padding:4px 8px 4px 10px;border-radius:var(--radius);
  ...
  .redline-page .rl-card{border:1px solid #e8ecf1;border-radius:var(--radius);padding:12px 14px 14px;
  ...
  ${''/* A RULE HAS NO CORNERS TO ROUND, so this names no radius at all — not
         even the platform's. It is a hairline under a caption: no fill, no
         box, nothing for a corner to happen to, and a declaration here would
         be noise the next reader has to rule out. */}
  ...
  .rl-rv-docnote{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin:0 0 14px;
    padding:8px 12px;border-radius:var(--radius);font-size:13px;line-height:1.5;
  ...
  .redline-page .rl-cnote{margin-top:8px;min-width:0;padding:8px 10px;border-radius:var(--radius);
  ...
  .redline-page .rl-cnote-int{margin-left:auto;flex:none;border:1px solid var(--color-divider);
    border-radius:var(--radius);padding:1px 7px;font-size:12px;font-weight:600;color:var(--color-neutral-500)}
  ...
  .redline-page textarea.rl-cnote-in{width:100%;margin-top:9px;border:1px solid var(--color-divider);
    border-radius:var(--radius);padding:8px 10px;font:inherit;font-size:14px;line-height:1.5;
  ...
  .redline-page .nego-visswitch button{border:1px solid var(--color-divider);background:var(--color-surface);
    border-radius:var(--radius);padding:3px 8px;font:inherit;font-size:12px;font-weight:600;cursor:pointer;
    color:var(--color-neutral-600)}
  ...
  .redline-page .rl-cp-segs{order:1;margin-left:auto;display:inline-flex;
    border:1px solid var(--color-divider);border-radius:var(--radius);overflow:hidden;flex:none}
  ...
  .redline-page .rl-cp-act{border:1px solid var(--color-divider);background:var(--color-surface);
    border-radius:var(--radius);padding:5px 12px;font:inherit;font-size:14px;font-weight:600;
  ...
  .redline-page .rl-cp-reopen{border:1px solid var(--color-divider);background:var(--color-surface);
    border-radius:var(--radius);padding:3px 10px;font:inherit;font-size:12px;font-weight:600;
  ...
  .redline-page .rl-q-row{display:flex;align-items:center;gap:4.5px;width:100%;text-align:left;
    ...
    border:1px solid transparent;border-radius:var(--radius);padding:8px 5px;margin-bottom:2px}
  ...
  .redline-page .rl-side{border-radius:var(--radius);overflow:visible;padding:12px 0 0}
  ...
  .redline-page .rl-idx-filter{font:inherit;font-size:12.5px;height:24px;
    ...
    padding:0 24px 0 8px;cursor:pointer;border-radius:var(--radius);appearance:none;-webkit-appearance:none;
