...
function pbHeadPill(sm){
  ...
  const chip=(bg,fg,txt)=>`<span style="flex:none;font-size:var(--t-label);font-weight:var(--w-title);border-radius:0;padding:2px 9px;background:${bg};color:${fg}">${txt}</span>`;
