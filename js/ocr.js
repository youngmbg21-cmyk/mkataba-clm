...
function ocrBannerHtml(u){
  ...
  if(!line) return '';
  return `<div style="display:flex;align-items:flex-start;gap:var(--s-2);border:1px solid var(--st-amber-line);background:var(--st-amber-bg);color:var(--st-amber-fg);border-radius:0;padding:var(--s-2) 11px;font-size:var(--t-meta);line-height:1.55;margin-bottom:var(--s-3)">
